    ...
    <div class="max-w-md w-full mx-auto px-4 py-8">
        <div class="bg-tactical-surface/80 backdrop-blur-sm border border-tactical-border rounded-xl shadow-xl p-8 relative overflow-hidden">
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="text-2xl font-orbitron font-bold text-tactical-text">OPERATION SIGN IN</h2>
                <p class="text-tactical-text/70 mt-1">Access your tactical command center</p>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div class="space-y-2">
                    <label for="email" class="input-label">
                        <i class="fas fa-user-secret mr-2"></i>Operator ID
                    </label>
                    <div class="relative">
                ...
                <div class="flex items-center">
                    <input id="remember_me" type="checkbox" name="remember" class="h-4 w-4 text-tactical-primary focus:ring-tactical-primary border-tactical-border rounded">
                    <label for="remember_me" class="ml-2 text-sm text-tactical-text/80">
                        Maintain Connection
                    </label>
                </div>
                ...
                <div class="pt-2">
                    <button type="submit" class="btn-primary w-full flex items-center justify-center py-2.5">
                        <i class="fas fa-sign-in-alt mr-2"></i> INITIATE SEQUENCE
                    </button>
                </div>
            </form>
